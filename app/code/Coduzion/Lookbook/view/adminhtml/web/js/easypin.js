...
return;
                    ...
                    var markerBorderX = clickPosX;
                    var markerBorderY = clickPosY;
                    ...
                    var absY = markerBorderY.toFixed(3);
...
return;
    ...
    var createPopup = function (elem, markerContainer) {
        ...
        $(modalContext).animate(
            ...
            $('#select-products-link', modalContext).click(function () {
                var modalOptions = {
                type: 'popup',
                responsive: true,
                innerScroll: true,
                ...
                buttons: [
                    {
                        text: $.mage.__('Okay'), // Button text
                        class: 'action-primary', // CSS class for styling
                        click: function () {
                            var categoryProductsValue = $('#in_category_products').val();
                            $('.select_product').val(categoryProductsValue);
                            jQuery('input[type="radio"]').prop('checked', false);
                            jQuery('input[type="radio"][value="' + categoryProductsValue + '"]').prop('checked', true);
                            this.closeModal();
                        }
                    },
                    {
                        text: $.mage.__('Close'), // Close button
            ...
            var modalContext = $('#product-grid-container');
            modalContext.modal(modalOptions);
...
return;
                ...
                var imageContainerWidth = parseInt(targetImage.parent().innerWidth());
                var imageContainerHeight = parseInt(targetImage.parent().innerHeight());                
                markerBorderX = (imageContainerWidth * markerBorderX) / imageWidth;
                markerBorderY = (imageContainerHeight * markerBorderY) / imageHeight;
