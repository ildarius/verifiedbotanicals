...
# Usage: BASE=https://example.com SKU=GMD25 dev/tools/polyshell_probe.sh [name]
...
{"cartItem":{"sku":"$SKU","qty":1,"quote_id":"$CART","product_option":{"extension_attributes":{"custom_options":[{"option_id":"1","option_value":"file","extension_attributes":{"file_info":{"base64_encoded_data":"$PNG","type":"image/png","name":"$NAME"}}}]}}}}
JSON
echo
